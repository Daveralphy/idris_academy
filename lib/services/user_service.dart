...
class UserService extends ChangeNotifier {
    ...
    'uid_12345': UserData(
      inProgressCourses: [
        CourseModel(
            ...
            description: 'Master the art of creating complex UIs with Flutter.',
            thumbnailUrl: 'https://placehold.co/600x400/F07C3B/000000/png?text=Flutter',
        ...
        CourseModel(
            ...
            description: 'Learn the most popular state management solution.',
            thumbnailUrl: 'https://placehold.co/600x400/74C7A3/000000/png?text=Provider',
      ...
      recommendedCourses: [
        CourseModel(
            ...
            thumbnailUrl: 'https://placehold.co/600x400/5C4D3E/FFFFFF/png?text=Physics',
            tags: ['Physics', 'Advanced']),
        CourseModel(
            id: 'cat4',
            title: 'Calculus for Further Maths',
            description: 'Deep dive into differentiation and integration for advanced problem-solving.',
            thumbnailUrl: 'https://placehold.co/600x400/F2EDD7/000000/png?text=Maths',
  ...
  Future<bool> login(String emailOrUsername, String password) async {
    ...
    if (emailOrUsername.toLowerCase() == 'newuser' && _mockUserPasswords['uid_67890'] == password) {
      _currentUser = UserModel(id: 'uid_67890', name: 'New User', username: 'newuser', email: 'newuser@example.com');
      _initializeUserDataForLogin(_currentUser!.id);
      announcementShownThisSession = false; // Reset on new login
      _loadImportantAnnouncement();
      notifyListeners();
  ...
  Future<String?> signup(String name, String username, String email, DateTime? dob, String? phoneNumber, String token, String password) async {
    ...
    _currentUser = UserModel(
      id: newId, name: name, username: username, email: email, dob: dob, phoneNumber: phoneNumber,
    );
  ...
  List<CourseModel> getCourseCatalog() {
    // In a real app, this would fetch all courses from your backend.
    // For now, we'll return a list of CourseModels with full content.
    return [
      CourseModel(
        id: 'cat1',
        ...
        thumbnailUrl: 'https://placehold.co/600x400/F07C3B/000000/png?text=Chemistry',
      ...
      CourseModel(
        ...
        thumbnailUrl: 'https://placehold.co/600x400/74C7A3/000000/png?text=Biology',
  ...
  void enrollInCourse(CourseModel course) {
    ...
    final newCourse = course.copyWith(
      ...
      modules: course.modules.map((module) => module.copyWith(
        submodules: module.submodules.map((sub) => sub.copyWith(isCompleted: false)).toList(),
      )).toList(),
    );
      ...
      return module.copyWith(
        submodules: module.submodules.map((submodule) {
          ...
          if (submodule.id == submoduleId) {
            final updatedSubmodule = submodule.copyWith(isCompleted: completed);
